...
public class ArrCharOps {
     ...
     *  If no such character is found, returns -1. asassaasdsaf
     */
    ...
    /* Returns an array which is the concatResult of the two given arrays.
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        char[] concatResult = new char[ arr1.length + arr2.length ];
        for ( int i = 0 ; i <  arr1.length; i++)
        {
            concatResult[i] = arr1[i];
        }
         for ( int i = 0; i < arr2.length; i++)
       {
        concatResult[i+ arr1.length] = arr2[i];
       }
        return concatResult ;
    }
     ...
     *  characters containing the characters "urge". hamburger 
     */     
